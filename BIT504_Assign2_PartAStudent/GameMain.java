...
public class GameMain extends JPanel implements MouseListener{
		...
		javax.swing.SwingUtilities.invokeLater(new Runnable() {
	         public void run() {
				...
				//TODO: create the new GameMain panel and add it to the frame
					...
					frame.add(game); /*instance of GameMain class is put into variable gamePanel which 
					    which is add to GUI JFrame */
					
				
				//TODO: set the default close operation of the frame to exit_on_close
		        
				frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);//exit the GUI upon closing 
				frame.pack();             
				frame.setLocationRelativeTo(null);
				frame.setVisible(true);
				frame.setResizable(true); // I added method that is handy "Resizable frame".
	         }
		 });
	}
	...
	public void paintComponent(Graphics g) {
		...
		if (currentState == GameState.PLAYING) {          
			...
			} else if (currentPlayer == Player.NOUGHT){  statusBar.setText("O's turn");  
	  ...
	  /** Initialise the game-board contents and the current status of GameState and Player) */
		...
		public void updateGame(Player thePlayer, int row, int col) {
			...
			//	else {
				//	currentState = GameState.PLAYING;//otherwise no change to current state of playing
			}
